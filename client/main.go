...
func main() {
	...
	apuesta := common.Apuesta{
		Name:     v.GetString("apuesta.name"),
		LastName: v.GetString("apuesta.last_name"),
		Document: v.GetString("apuesta.document"),
		Birthday: v.GetString("apuesta.birthday"),
		Number:   v.GetString("apuesta.number"),
	}
